...
// import { insertContactSchema, type InsertContact } from "../../../shared/schema";
import { insertContactSchema, type InsertContact } from "../shared/types";
import { projects } from "../../../shared/projects";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4 py-0 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h1 className="bg-gradient-to-r from-secondary via-chart-3 to-primary bg-clip-text text-transparent text-4xl md:text-6xl font-bold mb-6">
            Welcome to my <span className="text-accent2">CodeCircle</span>
          </h1>

          {/* Typing Effect */}
          <p className="bg-gradient-to-r from-primary via-chart-2 to-primary bg-clip-text text-transparent text-2xl md:text-3xl h-10 font-mono text-accent2 mb-8">
            {displayedText}
            <span className="animate-pulse">|</span>
          </p>

          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto">
            A space for systems development and technological creativity. Explore my dev stack, processes, 
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <Card className="border-card-border hover-elevate">
                ...
                <CardContent>
                  <p className="text-muted-foreground" data-testid="text-phone">+263 78 307 4722</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-card-border bg-gradient-to-br from-primary/10 to-chart-2/10">
                {/* <CardHeader>
                  <CardTitle className="text-lg text-center">Connect With Me</CardTitle>
                </CardHeader> */}
                <CardContent>
                  <div className="flex flex-wrap mt-6 justify-evenly">
                    <a
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+263 78 307 4722</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="h-10 w-10 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-1">
